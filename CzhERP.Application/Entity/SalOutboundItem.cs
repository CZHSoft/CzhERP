...
[SugarTable("Sal_OutboundItem", "销售出库明细")]
public partial class SalOutboundItem : EntityBase
{
    [Required]
    [SugarColumn(ColumnName = "OutboundId", ColumnDescription = "出库单ID")]
    public virtual long OutboundId { get; set; }

    [SugarColumn(ColumnName = "OrderItemId", ColumnDescription = "订单明细ID")]
    ...
    [SugarColumn(ColumnName = "OrderQuantity", ColumnDescription = "订单数量", DefaultValue = "0")]
    public virtual decimal OrderQuantity { get; set; } = 0;

    [Required]
    [SugarColumn(ColumnName = "OutboundQuantity", ColumnDescription = "出库数量")]
