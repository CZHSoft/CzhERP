...
[SugarTable("Sal_Outbound", "销售出库")]
public partial class SalOutbound : EntityBase
{
    [Required]
    [SugarColumn(ColumnName = "OutboundNo", ColumnDescription = "出库单号", Length = 50)]
    ...
    [Required]
    [SugarColumn(ColumnName = "OutboundDate", ColumnDescription = "出库日期")]
    ...
    [SugarColumn(ColumnName = "RejectReason", ColumnDescription = "拒绝原因", Length = 500)]
    public virtual string? RejectReason { get; set; }

    [SugarColumn(ColumnName = "RejectTime", ColumnDescription = "拒绝时间")]
    public virtual DateTime? RejectTime { get; set; }

    [SugarColumn(ColumnName = "RejectUserId", ColumnDescription = "拒绝人ID")]
    public virtual long? RejectUserId { get; set; }
