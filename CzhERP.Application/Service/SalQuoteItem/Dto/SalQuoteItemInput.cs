...
/// 报价单明细基础输入参数
/// </summary>
public class SalQuoteItemBaseInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
    ...
    /// 报价单ID
    /// </summary>
    [Required(ErrorMessage = "报价单ID不能为空")]
...
/// 报价单明细分页查询输入参数
/// </summary>
public class PageSalQuoteItemInput : BasePageInput
{
    /// <summary>
    /// 报价单ID
    /// </summary>
...
/// 报价单明细增加输入参数
/// </summary>
public class AddSalQuoteItemInput
{
    /// <summary>
    /// 报价单ID
    /// </summary>
...
/// 报价单明细删除输入参数
/// </summary>
public class DeleteSalQuoteItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 报价单明细更新输入参数
/// </summary>
public class UpdateSalQuoteItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>    
...
/// 报价单明细主键查询输入参数
/// </summary>
public class QueryByIdSalQuoteItemInput : DeleteSalQuoteItemInput
{
}
...
public class ImportSalQuoteItemInput : BaseImportInput
{
    /// <summary>
    /// 报价单ID
    /// </summary>
    [ImporterHeader(Name = "*报价单ID")]
    [ExporterHeader("*报价单ID", Format = "", Width = 25, IsBold = true)]
    public long? QuoteId { get; set; }
