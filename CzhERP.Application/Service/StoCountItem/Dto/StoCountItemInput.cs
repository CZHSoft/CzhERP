...
/// 盘点单明细表基础输入参数
/// </summary>
public class StoCountItemBaseInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
    ...
    /// 系统数量
    /// </summary>
    [Required(ErrorMessage = "系统数量不能为空")]
...
/// 盘点单明细表分页查询输入参数
/// </summary>
public class PageStoCountItemInput : BasePageInput
{
    /// <summary>
    /// 盘点单ID
    /// </summary>
...
/// 盘点单明细表增加输入参数
/// </summary>
public class AddStoCountItemInput
{
    /// <summary>
    /// 盘点单ID
    /// </summary>
...
/// 盘点单明细表删除输入参数
/// </summary>
public class DeleteStoCountItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 盘点单明细表更新输入参数
/// </summary>
public class UpdateStoCountItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>    
...
/// 盘点单明细表主键查询输入参数
/// </summary>
public class QueryByIdStoCountItemInput : DeleteStoCountItemInput
{
}
...
public class ImportStoCountItemInput : BaseImportInput
{
    /// <summary>
    /// 盘点单ID
    /// </summary>
    [ImporterHeader(Name = "*盘点单ID")]
    [ExporterHeader("*盘点单ID", Format = "", Width = 25, IsBold = true)]
    public long? CountId { get; set; }
    ...
    /// 系统数量
    /// </summary>
    [ImporterHeader(Name = "*系统数量")]
    [ExporterHeader("*系统数量", Format = "", Width = 25, IsBold = true)]
    public decimal? SystemQuantity { get; set; }
