...
/// 入库单明细表基础输入参数
/// </summary>
public class StoStockInItemBaseInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 入库单明细表分页查询输入参数
/// </summary>
public class PageStoStockInItemInput : BasePageInput
{
    /// <summary>
    /// 入库单ID
    /// </summary>
...
/// 入库单明细表增加输入参数
/// </summary>
public class AddStoStockInItemInput
{
    /// <summary>
    /// 入库单ID
    /// </summary>
    ...
    /// 入库库位
    /// </summary>
    [MaxLength(50, ErrorMessage = "入库库位字符长度不能超过50")]
    public string? LocationCode { get; set; }
...
/// 入库单明细表删除输入参数
/// </summary>
public class DeleteStoStockInItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 入库单明细表更新输入参数
/// </summary>
public class UpdateStoStockInItemInput
{
    /// <summary>
    /// 主键Id
    /// </summary>    
...
/// 入库单明细表主键查询输入参数
/// </summary>
public class QueryByIdStoStockInItemInput : DeleteStoStockInItemInput
{
}
...
public class ImportStoStockInItemInput : BaseImportInput
{
    /// <summary>
    /// 入库单ID
    /// </summary>
    ...
    [ExporterHeader("入库库位", Format = "", Width = 25, IsBold = true)]
    public string? LocationCode { get; set; }
